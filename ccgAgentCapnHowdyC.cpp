...
int ccgAgentCapnHowdyC(Hand hand, Card lastBowledCard, bool isBatting,
  ...
  // int bowlingCriterionPopulation[6] = {79, 118, 179, 141, 127, 161};
  ...
  } else  // is bowling
  {
    ...
    for (whichCard = 0; whichCard < numCardsPerHand; whichCard += 1) {
      ...
      // quality += myNumber * bowlingCriterionPopulation[0];
      //
      // if (myNumber >= bowledNumber) {
      ...
      //
      // if (myNumber < bowledNumber) {
      //   quality += bowlingCriterionPopulation[3];
      // }
      //
      // if (myNumber == getHighestOfHand(hand)) {
      //   quality += bowlingCriterionPopulation[4];
      // }
      //
      // if (mySuit == getMostFrequentSuit(hand, match)) {
      //   quality += bowlingCriterionPopulation[5];
      // }
